...
public class when_getting_membership_application_that_does_NOT_exist : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _response = await client.GetAsync($"/membershipapplications/{MembershipApplicationId.New()}");
    }
