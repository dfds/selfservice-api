...
public class FinalizeMembershipApplication : IMessageHandler<MembershipApplicationHasReceivedAnApproval>
{
    ...
    public FinalizeMembershipApplication(ILogger<FinalizeMembershipApplication> logger, IMembershipApplicationService membershipApplicationService)
    {
        _logger = logger;
    ...
    public async Task Handle(MembershipApplicationHasReceivedAnApproval message, MessageHandlerContext context)
    {
        ...
        _logger.LogDebug("Trying to finalize membership application {MembershipApplicationId}", membershipApplicationId);
