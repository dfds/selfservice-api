...
public class CapabilityMetrics
{
    ...
    public async Task UpdateCapabilityCache()
    {
        ...
        foreach (var capability in capabilities)
        {
            ...
            var jsonMetadataDeserialised = JsonSerializer.Deserialize<Dictionary<string, JsonElement>>(
                capability.JsonMetadata
            );
            ...
            var tags = new TagList { { "name", capability.Name }, { "id", capability.Id } };
