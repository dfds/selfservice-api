...
{
    public MessageContractExampleConverter()
    ...
    private static Expression<Func<string, MessageContractExample>> FromDatabaseType =>
        value => MessageContractExample.Parse(value);
}
