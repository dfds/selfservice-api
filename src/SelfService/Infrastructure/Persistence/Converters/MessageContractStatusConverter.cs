...
{
    public MessageContractStatusConverter()
    ...
    private static Expression<Func<string, MessageContractStatus>> FromDatabaseType =>
        value => MessageContractStatus.Parse(value);
}
