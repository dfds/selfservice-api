...
public class SelfServiceDbContext : DbContext
{
    ...
    public DbSet<EmailCampaignRecipientLog> EmailCampaignRecipientLogs => Set<EmailCampaignRecipientLog>();
    public DbSet<EmailCampaignExecution> EmailCampaignExecutions => Set<EmailCampaignExecution>();
    ...
    protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
    {
        ...
        configurationBuilder
            ...
            .HaveConversion<ValueObjectGuidConverter<EmailCampaignRecipientLogId>>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SelfAssessment>(cfg =>
        {
            cfg.ToTable("SelfAssessment");
            cfg.HasKey(x => x.Id);
            cfg.Property(x => x.Id).ValueGeneratedNever();
            cfg.Property(x => x.CapabilityId);
            cfg.Property(x => x.RequestedAt);
